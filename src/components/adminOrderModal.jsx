            ...
            >
                <div className="w-full max-h-[90vh] overflow-y-auto bg-primary flex flex-col rounded-2xl">
                    ...
                    <div className="w-full h-[55px] bg-accent rounded-t-2xl flex justify-center items-center gap-2 px-4 shrink-0">
                        <h1 className="text-lg text-white font-semibold">Order Details</h1>
                    ...
                    <div className="w-full flex flex-wrap justify-center items-center bg-white text-secondary sticky top-0 shadow-md px-4 py-2 gap-x-6 gap-y-1">
                        ...
                        {/* Status Selector */}
                        <div className="w-full flex flex-wrap justify-center items-center gap-3 border-t border-black/10 pt-2 pb-2">
                            <label className="text-sm font-semibold text-accent">Order Status:</label>
                            <select
                                value={orderStatus}
                                onChange={(e) => setOrderStatus(e.target.value)}
                                className="border border-secondary/30 rounded-lg px-3 py-1 text-sm bg-white text-secondary cursor-pointer outline-none focus:ring-2 focus:ring-accent/30"
                            >
                            ...
                            {orderStatus !== order.status && (
                                <button
                                    ...
                                    className="px-4 py-1.5 bg-green-600 hover:bg-green-700 text-white text-sm font-semibold rounded-lg cursor-pointer transition-colors duration-150"
                                >
                                    Save
                                </button>
                            )}
