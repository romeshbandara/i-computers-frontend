...
export default function ImageSlideShow(props){
    ...
    return(
        <div className="w-[500px] h-[600px] flex flex-col border-4 ">
            ...
            <div className="w-ful h-[100px] flex justify-center items-center gap-2">
               { 
                    images.map((image,index)=>{
                        return(
                            <img src={image} className={"w-[80px] h-[80px] object-contain cursor-pointer "+(index==activeImageIndex&&"border-2")} 
