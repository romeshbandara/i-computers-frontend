...
export default function CartPage() {
    ...
    return (
        <main className="w-full min-h-[calc(100vh-85px)] bg-[#020817] text-white relative overflow-hidden flex flex-col items-center pb-36 pt-6 px-4">
            ...
            <div className="absolute top-[15%] left-[15%] w-[500px] h-[500px] bg-blue-600/15 blur-[160px] rounded-full pointer-events-none" />
            <div className="absolute bottom-[20%] right-[15%] w-[450px] h-[450px] bg-purple-600/15 blur-[150px] rounded-full pointer-events-none" />

            <div className="relative z-10 w-full max-w-3xl flex flex-col items-center">
                <div className="w-full flex items-center justify-between mb-6">
                    <h1 className="text-2xl sm:text-3xl font-black">
                        Shopping <span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500 bg-clip-text text-transparent">Cart</span>
                    </h1>
                    {cart[0] != null && (
                ...
                {cart[0] == null ? (
                    <div className="w-full my-12 p-10 rounded-3xl bg-white/5 backdrop-blur-md border border-white/10 text-center flex flex-col items-center">
                        <TbMoodEmptyFilled className="text-7xl text-gray-500 mb-4" />
                        <h2 className="text-2xl font-bold text-white mb-2">Your Cart is Empty</h2>
                        <p className="text-gray-400 text-sm mb-6 max-w-sm">
                            Looks like you haven't added any computer gear or accessories to your cart yet.
                        </p>
                        <Link
                            to="/products"
                            className="px-7 py-3 rounded-full bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 font-semibold text-sm text-white shadow-lg shadow-blue-500/25 hover:scale-105 active:scale-95 transition-all"
                        >
                            Explore Products
                        </Link>
                    </div>
            ...
            {cart[0] != null && (
                <div className="fixed bottom-20 lg:bottom-6 w-[92%] max-w-3xl bg-[#020817]/90 backdrop-blur-xl border border-white/15 shadow-[0_10px_35px_rgba(0,0,0,0.6)] rounded-2xl p-4 flex justify-between items-center z-30">
                    <div>
                        <span className="text-xs text-gray-400 block">Total Amount</span>
                        <span className="text-2xl font-black text-cyan-400 drop-shadow-[0_0_10px_rgba(34,211,238,0.4)]">
                    ...
                    <Link
                        to="/checkout"
                        state={cart}
                        className="px-8 py-3 rounded-xl bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 font-bold text-sm sm:text-base text-white shadow-lg shadow-blue-500/25 hover:shadow-cyan-500/40 hover:scale-105 active:scale-95 transition-all cursor-pointer"
                    >
                        Proceed to Checkout
                    </Link>
                </div>
